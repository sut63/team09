...
// The ExtradoctorQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type ExtradoctorQueryRuleFunc func(context.Context, *ent.ExtradoctorQuery) error

// EvalQuery return f(ctx, q).
func (f ExtradoctorQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.ExtradoctorQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.ExtradoctorQuery", q)
}

// The ExtradoctorMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type ExtradoctorMutationRuleFunc func(context.Context, *ent.ExtradoctorMutation) error

// EvalMutation calls f(ctx, m).
func (f ExtradoctorMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.ExtradoctorMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.ExtradoctorMutation", m)
}
...
// functions as a query rule.
type ScheduleQueryRuleFunc func(context.Context, *ent.ScheduleQuery) error

// EvalQuery return f(ctx, q).
func (f ScheduleQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.ScheduleQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.ScheduleQuery", q)
}

// The ScheduleMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type ScheduleMutationRuleFunc func(context.Context, *ent.ScheduleMutation) error

// EvalMutation calls f(ctx, m).
func (f ScheduleMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.ScheduleMutation); ok {
		return f(ctx, m)
	}
...
// The TrainingQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type TrainingQueryRuleFunc func(context.Context, *ent.TrainingQuery) error

// EvalQuery return f(ctx, q).
func (f TrainingQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.TrainingQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.TrainingQuery", q)
}

// The TrainingMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type TrainingMutationRuleFunc func(context.Context, *ent.TrainingMutation) error

// EvalMutation calls f(ctx, m).
func (f TrainingMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.TrainingMutation); ok {
		return f(ctx, m)
	}
